...
public class FeatureServiceTester {
  ...
  FeatureServiceTester(String host, int port, String serviceName) {
    this.host = host;
    this.port = port;
  ...
  void getRecordsWithWhereClause(String where) {
    resetParameters2InitialValues();
    this.where = where == null? "" : where.trim();
  ...
  public static void main(String[] args) {
    FeatureServiceTester featureServiceTester = new FeatureServiceTester("localhost", 9000, "faa10k");
    long totalCount = featureServiceTester.getCount("1=1");
    System.out.println(totalCount);

    featureServiceTester.getRecordsWithWhereClause("1=1");
  }
}
